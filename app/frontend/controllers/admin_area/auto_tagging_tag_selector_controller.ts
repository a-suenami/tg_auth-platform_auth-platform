...
/**
 * Auto Tagging Tag Selector Controller
 *
 * Manages the chip-based UI for selecting tags in auto-tagging rules.
 *
 * Features:
...
export default class extends Controller {
  ...
  private createChip(tagId: string, tagName: string): HTMLElement {
    ...
    input.type = 'hidden';
    input.name = 'user_auto_tagging[user_tag_ids][]';
    input.value = tagId;
    input.id = `user_tag_${tagId}`;

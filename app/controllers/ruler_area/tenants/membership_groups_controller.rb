...
class RulerArea::Tenants::MembershipGroupsController < RulerArea::Tenants::ApplicationController
  ...
  def create
    ...
    if @membership_group.save
      redirect_to ruler_area_tenant_membership_group_path(@tenant, @membership_group), notice: 'メンバーシップグループを作成しました。'
    else
  ...
  def update
    if @membership_group.update(membership_group_params)
      redirect_to ruler_area_tenant_membership_group_path(@tenant, @membership_group), notice: 'メンバーシップグループを更新しました。'
    else
  ...
  def destroy
    ...
    redirect_to ruler_area_tenant_membership_groups_path(@tenant), notice: 'メンバーシップグループを削除しました。'
  end
  ...
  def update_memberships
    ...
    redirect_to ruler_area_tenant_membership_group_path(@tenant, @membership_group), notice: 'メンバーシップの紐づけを更新しました。'
  end
  ...
  def membership_group_params
    params.require(:membership_group).permit(:name, :display_name, :position)
  end
end

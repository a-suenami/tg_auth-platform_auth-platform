...
module API
  class ApplicationController < ActionController::API
    ...
    # Blueprinterヘルパーメソッド
    sig { params(blueprint_class: T.class_of(ApplicationBlueprint), object: T.untyped, options: T.untyped).void }
    def render_blueprint(blueprint_class, object, options = {})
      render json: blueprint_class.render_as_hash(object, options)
    end

    sig { params(blueprint_class: T.class_of(ApplicationBlueprint), collection: T.untyped, options: T.untyped).void }

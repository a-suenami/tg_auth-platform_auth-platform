...
module API::V1::Internal::Membership
  class ContractsController < API::V1::Internal::Membership::ApplicationController
    def index
      contracts = current_user.membership_contracts
                                   .includes(:payment_transactions)
                                   .order(created_at: :desc)

      render_blueprint_collection(Membership::ContractBlueprint, contracts, view: :detailed)
    end
    ...
    def show
      ...
      render_blueprint(Membership::ContractBlueprint, contract, view: :detailed)
    end

...
class StripeRecord
  class Charge < ApplicationRecord
    ...
    def assign_remote_attributes(remote_charge) # rubocop:disable Metrics/AbcSize
      ...
      self.balance_transaction_id = remote_charge.balance_transaction if remote_charge.balance_transaction.present? && remote_charge.balance_transaction.is_a?(String)

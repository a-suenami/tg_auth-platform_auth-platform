...
deleted: true, deleted_at: Time.zone.now,)
    ...
    let(:ignore_sms_verifiers) {
      create_list(:users__sms_verifier, 10, tenant_id: current_tenant.id, user: current_user, code: '123456', expired_at: 2.hours.from_now, remaining_attempts: 5, verifier_type: :registration,

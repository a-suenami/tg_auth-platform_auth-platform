...
class OauthAccessGrant
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, application_id: nil, code_challenge: nil, code_challenge_method: nil, created_at: nil, expires_in: nil, id: nil, redirect_uri: nil, resource_owner_id: nil, revoked_at: nil, scopes: nil, tenant_id: nil, token: nil, **nested); end

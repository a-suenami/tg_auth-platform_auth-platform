...
class Google::Protobuf::MethodOptions
  ...
  def initialize(deprecated: nil, features: nil, idempotency_level: nil, uninterpreted_option: Google::Protobuf::RepeatedField.new(:message, Google::Protobuf::UninterpretedOption)); end

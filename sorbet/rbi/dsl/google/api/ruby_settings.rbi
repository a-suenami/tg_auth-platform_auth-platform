...
# This is an autogenerated file for dynamic methods in `Google::Api::RubySettings`.
# Please instead update this file by running `bin/tapioca dsl Google::Api::RubySettings`.


class Google::Api::RubySettings < Google::Protobuf::AbstractMessage

...
# This is an autogenerated file for dynamic methods in `Google::Api::GoSettings`.
# Please instead update this file by running `bin/tapioca dsl Google::Api::GoSettings`.


class Google::Api::GoSettings < Google::Protobuf::AbstractMessage

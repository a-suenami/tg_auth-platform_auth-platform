...
class Google::Cloud::RecaptchaEnterprise::V1::Assessment < Google::Protobuf::AbstractMessage
  sig do
    params(
  ...
  sig { returns(Object) }
  def has_account_defender_assessment?; end

  sig { returns(Object) }
  def has_account_verification?; end

  sig { returns(Object) }
  def has_event?; end

  sig { returns(Object) }
  def has_firewall_policy_assessment?; end

  sig { returns(Object) }
  def has_fraud_prevention_assessment?; end

  sig { returns(Object) }
  def has_fraud_signals?; end

  sig { returns(Object) }
  def has_private_password_leak_verification?; end

  sig { returns(Object) }
  def has_risk_analysis?; end

  sig { returns(Object) }
  def has_token_properties?; end

...
class UserTag
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, id: nil, tenant_id: nil, name: nil, description: nil, created_by_id: nil, updated_by_id: nil, created_at: nil, updated_at: nil, integration_enabled: nil, **nested); end

...
class Payment::Transaction
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, activated_at: nil, chargeable_id: nil, chargeable_type: nil, created_at: nil, expired_at: nil, id: nil, membership_contract_id: nil, paid_amount: nil, payment_provider: nil, payment_type: nil, recurrence: nil, status: nil, tenant_id: nil, updated_at: nil, user_id: nil, **nested); end

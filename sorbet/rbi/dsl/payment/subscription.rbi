...
class Payment::Subscription
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, created_at: nil, id: nil, membership_contract_id: nil, subscribable_id: nil, subscribable_type: nil, tenant_id: nil, updated_at: nil, user_id: nil, **nested); end

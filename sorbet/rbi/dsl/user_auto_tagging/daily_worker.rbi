...
# This is an autogenerated file for dynamic methods in `UserAutoTagging::DailyWorker`.
# Please instead update this file by running `bin/tapioca dsl UserAutoTagging::DailyWorker`.

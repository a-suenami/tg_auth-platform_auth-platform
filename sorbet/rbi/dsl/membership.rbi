...
class Membership
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, id: nil, tenant_id: nil, membership_group_id: nil, name: nil, display_name: nil, position: nil, tier: nil, created_at: nil, updated_at: nil, **nested); end

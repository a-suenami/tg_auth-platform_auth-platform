...
class Membership
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, created_at: nil, display_name: nil, id: nil, membership_group_id: nil, name: nil, position: nil, tenant_id: nil, tier: nil, updated_at: nil, **nested); end

...
class Template::Mail::Version
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, body: nil, created_at: nil, id: nil, public_started_at: nil, published_by_id: nil, template_id: nil, tenant_id: nil, title: nil, updated_at: nil, version: nil, **nested); end

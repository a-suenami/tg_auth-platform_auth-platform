...
class KomojuRecord::Payment
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, amount: nil, authorized_at: nil, captured_at: nil, confirmation_code: nil, created_at: nil, expired_at: nil, id: nil, komoju_data: nil, payment_deadline: nil, remote_id: nil, status: nil, tenant_id: nil, updated_at: nil, user_id: nil, **nested); end

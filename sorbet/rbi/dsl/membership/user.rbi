...
class Membership::User
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, activated_at: nil, created_at: nil, expired_at: nil, id: nil, membership_contract_id: nil, membership_group_id: nil, membership_id: nil, status: nil, tenant_id: nil, updated_at: nil, user_id: nil, **nested); end

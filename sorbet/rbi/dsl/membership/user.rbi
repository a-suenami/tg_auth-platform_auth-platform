...
class Membership::User
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, id: nil, tenant_id: nil, user_id: nil, membership_id: nil, membership_group_id: nil, membership_contract_id: nil, expired_at: nil, status: nil, created_at: nil, updated_at: nil, activated_at: nil, **nested); end

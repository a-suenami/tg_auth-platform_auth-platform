...
class Membership::Contract
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, id: nil, tenant_id: nil, user_id: nil, expired_at: nil, cancel_at_period_end: nil, status: nil, created_at: nil, updated_at: nil, **nested); end

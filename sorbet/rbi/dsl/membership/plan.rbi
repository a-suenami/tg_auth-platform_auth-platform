...
class Membership::Plan
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, amount: nil, anchor_day_of_month: nil, billing_anchor: nil, created_at: nil, disabled_at: nil, enabled_at: nil, id: nil, is_active: nil, name: nil, position: nil, recurrence: nil, recurring_interval_count: nil, recurring_interval_unit: nil, tenant_id: nil, trial_period_days: nil, updated_at: nil, **nested); end

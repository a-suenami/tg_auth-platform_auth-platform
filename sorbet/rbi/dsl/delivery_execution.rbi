...
class DeliveryExecution
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, id: nil, tenant_id: nil, delivery_id: nil, user_id: nil, status: nil, scheduled_for: nil, sent_at: nil, error_message: nil, created_at: nil, updated_at: nil, **nested); end

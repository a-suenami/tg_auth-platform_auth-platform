...
class DeliverySchedule
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, id: nil, tenant_id: nil, delivery_id: nil, status: nil, scheduled_at: nil, published_at: nil, published_by_id: nil, created_at: nil, updated_at: nil, **nested); end

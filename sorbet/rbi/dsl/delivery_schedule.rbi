...
class DeliverySchedule
  ...
  module GeneratedAssociationRelationMethods
    ...
    def where(string_query = nil, blastengine_delivery_id: nil, blastengine_job_id: nil, created_at: nil, delivery_id: nil, id: nil, published_at: nil, published_by_id: nil, scheduled_at: nil, setup_completed_at: nil, status: nil, tenant_id: nil, updated_at: nil, **nested); end

...
# JWT Validator class
#
# source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#10
class OmniAuth::Auth0::JWTValidator
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#20
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#47
  def decode(jwt); end
  ...
  # @return nil|string
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#98
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#87
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#77
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#59
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#34
  ...
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#152
  def blank?(obj); end
  ...
  # @return hash
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#109
  def decode_opts(alg); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#122
  ...
  # @return hash
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#159
  ...
  # @return void
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#144
  def jwks; end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#132
  ...
  # @return string
  #
  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#166
  def uri_string(uri); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#206
  def verify_aud(id_token); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#255
  def verify_auth_time(id_token, leeway, max_age); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#243
  def verify_azp(id_token); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#173
  def verify_claims(id_token, authorize_params); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#217
  def verify_expiration(id_token, leeway); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#226
  def verify_iat(id_token); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#190
  def verify_iss(id_token); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#232
  def verify_nonce(id_token, nonce); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#266
  def verify_org(id_token, organization); end

  # source://omniauth-auth0//lib/omniauth/auth0/jwt_validator.rb#199

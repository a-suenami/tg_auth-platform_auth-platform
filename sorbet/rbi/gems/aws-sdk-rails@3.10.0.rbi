...
module ActionDispatch
  # source://actionpack/7.1.3/lib/action_dispatch.rb#141
  def eager_load!; end

  # source://actionpack/7.1.3/lib/action_dispatch.rb#127
  def test_app; end
  ...
  class << self
    # source://actionpack/7.1.3/lib/action_dispatch/deprecator.rb#4
    def deprecator; end
...
module ActionDispatch::Session
  class << self
    # source://actionpack/7.1.3/lib/action_dispatch.rb#113
...
module ActiveJob
  class << self
    # source://activejob/7.1.3/lib/active_job/queue_adapter.rb#7
    def adapter_name(adapter); end

    # source://activejob/7.1.3/lib/active_job/deprecator.rb#4
    def deprecator; end

    # source://activejob/7.1.3/lib/active_job/gem_version.rb#5
    def gem_version; end

    # source://activejob/7.1.3/lib/active_job/enqueuing.rb#16
    def perform_all_later(*jobs); end

    # source://activejob/7.1.3/lib/active_job.rb#53
    def use_big_decimal_serializer; end

    # source://activejob/7.1.3/lib/active_job.rb#53
    def use_big_decimal_serializer=(_arg0); end

    # source://activejob/7.1.3/lib/active_job.rb#61
    def verbose_enqueue_logs; end

    # source://activejob/7.1.3/lib/active_job.rb#61
    def verbose_enqueue_logs=(_arg0); end

    # source://activejob/7.1.3/lib/active_job/version.rb#7
    def version; end

    private

    # source://activejob/7.1.3/lib/active_job/instrumentation.rb#6
...
module ActiveJob::QueueAdapters
  class << self
    # source://activejob/7.1.3/lib/active_job/queue_adapters.rb#137
    def lookup(name); end
  end
end
...
class AwsRecord::Generators::Base < ::Rails::Generators::NamedBase
  ...
  # source://railties/7.1.3/lib/rails/generators/named_base.rb#215

...
# source://vite_ruby//lib/vite_ruby/version.rb#3
class ViteRuby
  # @return [ViteRuby] a new instance of ViteRuby
  #
  # source://vite_ruby//lib/vite_ruby.rb#71
  ...
  # @return [Boolean]
  #
  # source://vite_ruby//lib/vite_ruby.rb#81
  ...
  #
  # source://vite_ruby//lib/vite_ruby.rb#96
  def env; end

  # source://vite_ruby//lib/vite_ruby.rb#75
  def logger; end
  ...
  #
  # source://vite_ruby//lib/vite_ruby.rb#69
  def logger=(_arg0); end

  # Public: Enables looking up assets managed by Vite using name and type.
  #
  # source://vite_ruby//lib/vite_ruby.rb#134
  def manifest; end
  ...
  class << self
    ...
    #
    # source://vite_ruby//lib/vite_ruby.rb#44
    def bootstrap; end
    ...
    #
    # source://vite_ruby//lib/vite_ruby.rb#60
    def framework_libraries; end

    # Internal: Loads all available rake tasks.
    #
    # source://vite_ruby//lib/vite_ruby.rb#49
    def install_tasks; end

    # source://vite_ruby//lib/vite_ruby.rb#39
    def instance; end
    ...
    #
    # source://vite_ruby//lib/vite_ruby.rb#54
...
# source://vite_ruby//lib/vite_ruby/build.rb#6
class ViteRuby::Build < ::Struct
  ...
  # source://vite_ruby//lib/vite_ruby/build.rb#26
  def fresh?; end

  # source://vite_ruby//lib/vite_ruby/build.rb#32
  def retry_failed?; end

  # source://vite_ruby//lib/vite_ruby/build.rb#20
  def stale?; end
  ...
  # source://vite_ruby//lib/vite_ruby/build.rb#39
  def with_result(success); end

  class << self
    def [](*_arg0); end

    # source://vite_ruby//lib/vite_ruby/build.rb#8
    def from_previous(attrs, current_digest); end
...
class ViteRuby::Builder
  ...
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#8
  ...
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#14
  def build(*args); end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#28
  def last_build_metadata; end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#69
  ...
  def last_build_attrs; end

  # Internal: The file path where metadata of the last build is stored.
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#52
  ...
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#81
  def log_build_result(_stdout, stderr, status); end

  # Internal: Writes a digest of the watched files to disk for future checks.
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#46
  def record_build_metadata(success, build); end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/builder.rb#58
...
class ViteRuby::CLI::Build < ::ViteRuby::CLI::Vite
  # source://vite_ruby//lib/vite_ruby/cli/build.rb#11
...
class ViteRuby::CLI::Install < ::Dry::CLI::Command
  ...
  #
  # source://vite_rails/4.0.0.alpha1/lib/vite_rails/installation.rb#43
  def install_sample_files; end

  # Internal: Setup for a plain Rack application.
  #
  # source://vite_rails/4.0.0.alpha1/lib/vite_rails/installation.rb#11
  ...
  #
  # source://vite_ruby//lib/vite_ruby/cli/install.rb#121
  def npm_install; end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/cli/install.rb#105
  def root; end

  # source://vite_ruby//lib/vite_ruby/cli/install.rb#113
  def run_with_capture(*args, **options); end

  # source://vite_ruby//lib/vite_ruby/cli/install.rb#109
  def say(*args); end

  # Internal: Avoid printing warning about missing vite.json, we will create one.
  #
  # source://vite_ruby//lib/vite_ruby/cli/install.rb#129
...
class ViteRuby::CLI::Vite < ::Dry::CLI::Command
  ...
  # @yield [args]
  #
  # source://vite_ruby//lib/vite_ruby/cli/vite.rb#14
...
#
# source://vite_ruby//lib/vite_ruby.rb#24
...
class ViteRuby::Commands
  ...
  #
  # source://vite_ruby//lib/vite_ruby/commands.rb#92
  def print_info; end
  ...
  # source://vite_ruby//lib/vite_ruby/commands.rb#127
  def clean_files(files); end

  # source://vite_ruby//lib/vite_ruby/commands.rb#142
  def current_version_files; end

  # source://vite_ruby//lib/vite_ruby/commands.rb#154
  def ensure_log_goes_to_stdout; end

  # @return [Boolean]
  #
  # source://vite_ruby//lib/vite_ruby/commands.rb#123
  def may_clean?; end

  # source://vite_ruby//lib/vite_ruby/commands.rb#134
  def versions; end

  # source://vite_ruby//lib/vite_ruby/commands.rb#146
...
class ViteRuby::Config
  ...
  #
  # source://vite_ruby//lib/vite_ruby/config.rb#90
  def initialize(attrs); end

  # source://vite_ruby//lib/vite_ruby/config.rb#187
  ...
  #
  # source://vite_ruby//lib/vite_ruby/config.rb#53
  def to_env; end
  ...
  class << self
    ...
    #
    # source://vite_ruby//lib/vite_ruby/config.rb#142
    def config_from_env; end

    # Internal: Loads the configuration options provided in a JSON file.
    #
    # source://vite_ruby//lib/vite_ruby/config.rb#151
    def config_from_file(path, mode:); end

    # Internal: Used to load a JSON file from the specified path.
    #
    # source://vite_ruby//lib/vite_ruby/config.rb#128
    ...
    #
    # source://vite_ruby//lib/vite_ruby/config.rb#137
...
class ViteRuby::DevServerProxy < ::Rack::Proxy
  ...
  # @return [Boolean]
  #
  # source://vite_ruby//lib/vite_ruby/dev_server_proxy.rb#62
  ...
  # source://vite_ruby//lib/vite_ruby/dev_server_proxy.rb#67
  def vite_asset_url_prefix; end
...
#
# source://vite_ruby//lib/vite_ruby.rb#21
...
class ViteRuby::Manifest
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#44
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#82
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#71
  def lookup!(name, **options); end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#104
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#116
  def manifest; end
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#202
  ...
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#169
  ...
  # @return [Boolean]
  #
  # source://vite_ruby//lib/vite_ruby/manifest.rb#99
...
#
# source://vite_ruby//lib/vite_ruby/manifest.rb#66
ViteRuby::Manifest::TO_ENTRY = T.let(T.unsafe(nil), Proc)
...
# source://vite_ruby//lib/vite_ruby/missing_entrypoint_error.rb#35
ViteRuby::MissingEntrypointError::DEFAULT_CAUSES = T.let(T.unsafe(nil), String)

# source://vite_ruby//lib/vite_ruby/missing_entrypoint_error.rb#31
ViteRuby::MissingEntrypointError::FAILED_BUILD_CAUSES = T.let(T.unsafe(nil), String)

# source://vite_ruby//lib/vite_ruby/missing_entrypoint_error.rb#41

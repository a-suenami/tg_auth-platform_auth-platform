...
class Zache
  ...
  # calculated result will be returned if it exists and is already expired.
  #
  # source://zache//lib/zache.rb#97
  def get(key, lifetime: T.unsafe(nil), dirty: T.unsafe(nil)); end

  # source://auth0/5.12.0/lib/auth0/mixins/validation.rb#4
  def last(key); end
  ...
  #
  # source://zache//lib/zache.rb#164
  def remove_all; end

  # Remove all keys that match the block.
  #
  # source://zache//lib/zache.rb#169
  def remove_by; end

  # Total number of keys currently in cache.
  #
  # source://zache//lib/zache.rb#84
  def size; end

  private

  # source://zache//lib/zache.rb#184
  def calc(key, lifetime); end

  # source://zache//lib/zache.rb#197

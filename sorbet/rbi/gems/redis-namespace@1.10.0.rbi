...
class Redis
  ...
  # source://redis/5.0.6/lib/redis.rb#118
  def dup; end

  # source://redis/5.0.6/lib/redis.rb#110
  def id; end

  # source://redis/5.0.6/lib/redis.rb#114
  def inspect; end
  ...
  # source://redis/5.0.6/lib/redis.rb#177
  def _subscription(method, timeout, channels, block); end

  # source://redis/5.0.6/lib/redis.rb#134
  def initialize_client(options); end

  # source://redis/5.0.6/lib/redis.rb#171
  def send_blocking_command(command, timeout, &block); end

  # source://redis/5.0.6/lib/redis.rb#165
  def send_command(command, &block); end

  # source://redis/5.0.6/lib/redis.rb#161
  def synchronize; end

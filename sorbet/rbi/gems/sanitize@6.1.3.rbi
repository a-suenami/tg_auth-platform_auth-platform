...
class Sanitize
  ...
  #
  # source://sanitize//lib/sanitize.rb#144
  def clean(html); end
  ...
  #
  # source://sanitize//lib/sanitize.rb#132
  ...
  # @raise [ArgumentError]
  #
  # source://sanitize//lib/sanitize.rb#170
  ...
  class << self
    ...
    # @deprecated Use {.fragment} instead.
    #
    # source://sanitize//lib/sanitize.rb#81
    ...
    # @deprecated Use {.document} instead.
    #
    # source://sanitize//lib/sanitize.rb#78
    ...
    # @deprecated Use {.node!} instead.
    #
    # source://sanitize//lib/sanitize.rb#84
...
class Sanitize::CSS
  ...
  # @return [Boolean]
  #
  # source://sanitize//lib/sanitize/css.rb#240
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#253
  ...
  # @return [Boolean]
  #
  # source://sanitize//lib/sanitize/css.rb#360
  ...
  # @return [Boolean]
  #
  # source://sanitize//lib/sanitize/css.rb#311

...
class Sidekiq::Batch::Callback
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/job.rb#137
  def sidekiq_options_hash; end

  # source://sidekiq/7.1.6/lib/sidekiq/job.rb#149
  ...
  class << self
    # source://sidekiq/7.1.6/lib/sidekiq/job.rb#104
    def sidekiq_options_hash; end

    # source://sidekiq/7.1.6/lib/sidekiq/job.rb#112
    ...
    # source://sidekiq/7.1.6/lib/sidekiq/job.rb#99
...
class Sidekiq::Client
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/client.rb#45
  def initialize(*args, **kwargs); end

  # source://sidekiq/7.1.6/lib/sidekiq/client.rb#23
  def middleware(&block); end

  # source://sidekiq/7.1.6/lib/sidekiq/client.rb#86
  def push(item); end

  # source://sidekiq/7.1.6/lib/sidekiq/client.rb#116
  def push_bulk(items); end

  # source://sidekiq/7.1.6/lib/sidekiq/client.rb#31
  def redis_pool; end
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/client.rb#248
  ...
  class << self
    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#189
    def enqueue(klass, *args); end

    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#217
    def enqueue_in(interval, klass, *args); end

    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#196
    def enqueue_to(queue, klass, *args); end

    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#203
    def enqueue_to_in(queue, interval, klass, *args); end

    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#173
    def push(item); end

    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#177
    def push_bulk(*_arg0, **_arg1, &_arg2); end

    # source://sidekiq-pro//lib/sidekiq/pro/push.rb#91
    def reliable_push!; end

    # source://sidekiq/7.1.6/lib/sidekiq/client.rb#163
    def via(pool); end
  end
end
...
module Sidekiq::Component
  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#7
  def config; end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#51
  def fire_event(event, options = T.unsafe(nil)); end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#47
  def handle_exception(ex, ctx = T.unsafe(nil)); end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#35
  def hostname; end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#43
  def identity; end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#23
  def logger; end

  # source://sidekiq-pro//lib/sidekiq/pro/metrics.rb#37
  def metrics(&block); end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#39
  def process_nonce; end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#27
  def redis(&block); end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#16
  def safe_thread(name, &block); end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#31
  def tid; end

  # source://sidekiq/7.1.6/lib/sidekiq/component.rb#9
...
class Sidekiq::Config
  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#47
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#212
  def average_scheduled_poll_interval=(interval); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#111
  def capsule(name); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#56
  def capsules; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#94
  def client_middleware; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#68
  def concurrency; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#64
  def concurrency=(val); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#203
  def death_handlers; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#106
  def default_capsule(&block); end

  # source://sidekiq-pro//lib/sidekiq/pro/metrics.rb#6
  def dogstatsd=(thing); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#223
  def error_handlers; end

  # source://forwardable/1.3.3/forwardable.rb#231
  def fetch(*args, **_arg1, &block); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#267
  def handle_exception(ex, ctx = T.unsafe(nil)); end
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#241
  def logger; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#252
  def logger=(logger); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#186
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#136
  def new_redis_pool(size, name = T.unsafe(nil)); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#235
  def on(event, &block); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#90
  def queues; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#86
  def queues=(val); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#158
  def redis; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#122
  def redis=(hash); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#142
  def redis_info; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#126
  def redis_pool; end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#181
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#100
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#58
  def to_json(*_arg0); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#72
  def total_concurrency; end

  private

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#261
  def arity(handler); end

  # source://sidekiq/7.1.6/lib/sidekiq/config.rb#130
...
module Sidekiq::Job
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/job.rb#156
  def jid; end

  # source://sidekiq/7.1.6/lib/sidekiq/job.rb#156
  def jid=(_arg0); end

  # source://sidekiq/7.1.6/lib/sidekiq/job.rb#165
  def logger; end
  ...
  class << self
    # source://sidekiq/7.1.6/lib/sidekiq/job.rb#158
...
class Sidekiq::Queue
  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#242
  def initialize(name = T.unsafe(nil)); end

  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#325
  def as_json(options = T.unsafe(nil)); end

  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#312
  def clear; end
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#276
  def each; end

  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#306
  def find_job(jid); end

  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#265
  def latency; end

  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#239
  def name; end
  ...
  # source://sidekiq/7.1.6/lib/sidekiq/api.rb#251
  def size; end
  ...
  class << self
    # source://sidekiq/7.1.6/lib/sidekiq/api.rb#235
    def all; end
  end
end
...
module Sidekiq::ServerMiddleware
  # source://sidekiq/7.1.6/lib/sidekiq/middleware/modules.rb#5
  def config; end

  # source://sidekiq/7.1.6/lib/sidekiq/middleware/modules.rb#5
  def config=(_arg0); end

  # source://sidekiq/7.1.6/lib/sidekiq/middleware/modules.rb#10
  def logger; end

  # source://sidekiq-pro//lib/sidekiq/pro/metrics.rb#31
  def metrics(&block); end

  # source://sidekiq/7.1.6/lib/sidekiq/middleware/modules.rb#14
  def redis(&block); end

  # source://sidekiq/7.1.6/lib/sidekiq/middleware/modules.rb#6
  def redis_pool; end
end

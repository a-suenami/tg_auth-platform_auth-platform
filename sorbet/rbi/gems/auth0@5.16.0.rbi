...
module Auth0::Api::AuthenticationEndpoints
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#310
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#212
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#52
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#125
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#81
  ...
  # @param scope [string] The scope (defaults to 'openid profile email')
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#104
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#155
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#349
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#331
  ...
  # @see https://auth0.com/docs/api/authentication#authorization-code-grant
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#368
  ...
  # @see https://auth0.com/docs/connections/database/password-change
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#232
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#287
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#391
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#190
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#250
  ...
  # @see https://auth0.com/docs/connections/passwordless#passwordless-on-regular-web-apps
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#270
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#301
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#436
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#294
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#403
  ...
  #
  # source://auth0//lib/auth0/api/authentication_endpoints.rb#455
...
module Auth0::Api::V2::Actions
  ...
  # actions API path
  #
  # source://auth0//lib/auth0/api/v2/actions.rb#203
...
module Auth0::Api::V2::AttackProtection
  ...
  #
  # source://auth0//lib/auth0/api/v2/attack_protection.rb#60
...
module Auth0::Api::V2::Blacklists
  ...
  # Blacklists API path
  #
  # source://auth0//lib/auth0/api/v2/blacklists.rb#39
...
module Auth0::Api::V2::Branding
  ...
  # Branding API path
  #
  # source://auth0//lib/auth0/api/v2/branding.rb#55
...
module Auth0::Api::V2::ClientGrants
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#16
  def client_grants(client_id: T.unsafe(nil), audience: T.unsafe(nil), page: T.unsafe(nil), per_page: T.unsafe(nil), allow_any_organization: T.unsafe(nil)); end
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#33
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#41
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#16
  def get_all_client_grants(client_id: T.unsafe(nil), audience: T.unsafe(nil), page: T.unsafe(nil), per_page: T.unsafe(nil), allow_any_organization: T.unsafe(nil)); end
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#69
  def get_client_grants_organizations(client_grant_id, options = T.unsafe(nil)); end
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#51
  ...
  #
  # source://auth0//lib/auth0/api/v2/client_grants.rb#85
...
module Auth0::Api::V2::Clients
  ...
  # Clients API path
  #
  # source://auth0//lib/auth0/api/v2/clients.rb#117
...
module Auth0::Api::V2::Connections
  ...
  #
  # source://auth0//lib/auth0/api/v2/connections.rb#109
...
module Auth0::Api::V2::DeviceCredentials
  ...
  #
  # source://auth0//lib/auth0/api/v2/device_credentials.rb#76
...
module Auth0::Api::V2::Emails
  ...
  #
  # source://auth0//lib/auth0/api/v2/emails.rb#50
  def email_path; end
end
...
module Auth0::Api::V2::Grants
  ...
  # Grants API path
  #
  # source://auth0//lib/auth0/api/v2/grants.rb#43
  def grants_path; end
end
...
module Auth0::Api::V2::LogStreams
  ...
  #
  # source://auth0//lib/auth0/api/v2/log_streams.rb#72
...
module Auth0::Api::V2::Logs
  ...
  # Logs API path
  #
  # source://auth0//lib/auth0/api/v2/logs.rb#59
  def logs_path; end
end
...
module Auth0::Api::V2::Organizations
  ...
  # @raise [Auth0::MissingOrganizationId]
  #
  # source://auth0//lib/auth0/api/v2/organizations.rb#357
  def create_organizations_client_grant(organization_id, grant_id); end
  ...
  # @raise [Auth0::MissingOrganizationId]
  #
  # source://auth0//lib/auth0/api/v2/organizations.rb#371
  def delete_organizations_client_grant(organization_id, grant_id); end
  ...
  # @raise [Auth0::MissingOrganizationId]
  #
  # source://auth0//lib/auth0/api/v2/organizations.rb#341
  def get_organizations_client_grants(organization_id, options = T.unsafe(nil)); end
  ...
  # source://auth0//lib/auth0/api/v2/organizations.rb#401
  def organizations_client_grants_path(org_id); end

  # source://auth0//lib/auth0/api/v2/organizations.rb#385
  def organizations_enabled_connections_path(org_id); end

  # source://auth0//lib/auth0/api/v2/organizations.rb#397
  def organizations_invitations_path(org_id); end

  # source://auth0//lib/auth0/api/v2/organizations.rb#393
  def organizations_member_roles_path(org_id, user_id); end

  # source://auth0//lib/auth0/api/v2/organizations.rb#389
  def organizations_members_path(org_id); end

  # Organizations API path
  #
  # source://auth0//lib/auth0/api/v2/organizations.rb#381
...
module Auth0::Api::V2::Prompts
  ...
  #
  # source://auth0//lib/auth0/api/v2/prompts.rb#64
...
module Auth0::Api::V2::ResourceServers
  ...
  #
  # source://auth0//lib/auth0/api/v2/resource_servers.rb#79
...
module Auth0::Api::V2::Rules
  ...
  # Rules API path
  #
  # source://auth0//lib/auth0/api/v2/rules.rb#103
  def rules_path; end
end
...
module Auth0::Api::V2::Stats
  ...
  # Stats API path
  #
  # source://auth0//lib/auth0/api/v2/stats.rb#35
  def stats_path; end
end
...
module Auth0::Api::V2::Tenants
  ...
  #
  # source://auth0//lib/auth0/api/v2/tenants.rb#35
  def tenant_path; end
end
...
module Auth0::Api::V2::Tickets
  ...
  # Tickets API path
  #
  # source://auth0//lib/auth0/api/v2/tickets.rb#98
...
module Auth0::Api::V2::UserBlocks
  ...
  #
  # source://auth0//lib/auth0/api/v2/user_blocks.rb#56
...
module Auth0::Api::V2::Users
  ...
  # Users API path
  #
  # source://auth0//lib/auth0/api/v2/users.rb#451
  def users_path; end
end
...
module Auth0::Api::V2::UsersByEmail
  ...
  #
  # source://auth0//lib/auth0/api/v2/users_by_email.rb#30
...
class Zache
  # source://zache/0.13.1/lib/zache.rb#77
  def initialize(sync: T.unsafe(nil), dirty: T.unsafe(nil)); end

  # source://zache/0.13.1/lib/zache.rb#179
  def clean; end

  # source://zache/0.13.1/lib/zache.rb#119
  def exists?(key, dirty: T.unsafe(nil)); end

  # source://zache/0.13.1/lib/zache.rb#130
  def expired?(key); end

  # source://zache/0.13.1/lib/zache.rb#100
  def get(key, lifetime: T.unsafe(nil), dirty: T.unsafe(nil), &block); end

  # source://auth0//lib/auth0/mixins/validation.rb#4
  def last(key); end

  # source://zache/0.13.1/lib/zache.rb#143
  def locked?; end

  # source://zache/0.13.1/lib/zache.rb#137
  def mtime(key); end

  # source://zache/0.13.1/lib/zache.rb#148
  def put(key, value, lifetime: T.unsafe(nil)); end

  # source://zache/0.13.1/lib/zache.rb#160
  def remove(key); end

  # source://zache/0.13.1/lib/zache.rb#165
  def remove_all; end

  # source://zache/0.13.1/lib/zache.rb#170
  def remove_by; end

  # source://zache/0.13.1/lib/zache.rb#85
  def size; end

  private

  # source://zache/0.13.1/lib/zache.rb#185
  def calc(key, lifetime); end

  # source://zache/0.13.1/lib/zache.rb#198
